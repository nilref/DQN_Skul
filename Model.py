...
class Model:
    def __init__(self, input_shape, act_dim, move_dim):
    ...
    def load_model(self):
        ...
        if os.path.exists("./model/act_part.h5"):
            ...
            self.private_act_model = load_model("./model/act_part.h5", custom_objects={'BasicBlock': BasicBlock}, compile=False)
        ...
        if os.path.exists("./model/move_part.h5"):
            ...
            self.private_move_model = load_model("./model/move_part.h5", custom_objects={'BasicBlock': BasicBlock}, compile=False)
    ...
    def _build_model(self):
       ...
       # ------------------ build evaluate_net ------------------
        ...
        self.private_move_model.add(Dense(self.move_dim, name="d1"))
